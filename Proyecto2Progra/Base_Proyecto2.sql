...
CREATE TABLE IF NOT EXISTS `comentario` (
  ...
  `usuario_coment_id` VARCHAR(20) NOT NULL,
  PRIMARY KEY (`id_comentario`),
  INDEX `fk_coment_usuario_idx` (`usuario_coment_id` ASC) VISIBLE,
  CONSTRAINT `fk_coment_usuario` FOREIGN KEY (`usuario_coment_id`) REFERENCES `usuario` (`id`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `progra4`.`usuario` (`id`, `tipo`, `password`, `nombre`, `apellido1`, `apellido2`, `direccion`, `telefono`) VALUES ('444', 'Cliente', '123', 'kevin', 'Artavia', 'Arguedas', 'La Fortuna', '88888888');
INSERT INTO `progra4`.`usuario` (`id`, `tipo`, `password`, `nombre`, `apellido1`, `apellido2`, `direccion`, `telefono`) VALUES ('555', 'Administrador', '123', 'Ian', 'Artavia', 'Cruz', 'La Fortuna', '88888888');

INSERT INTO `progra4`.`ingredientes` (`ID`, `nombre`, `precio`) VALUES ('1', 'salsa', '300');
INSERT INTO `progra4`.`ingredientes` (`ID`, `nombre`, `precio`) VALUES ('2', 'jamon', '600');
INSERT INTO `progra4`.`ingredientes` (`ID`, `nombre`, `precio`) VALUES ('3', 'hongos', '600');
INSERT INTO `progra4`.`ingredientes` (`ID`, `nombre`, `precio`) VALUES ('4', 'queso', '800');
INSERT INTO `progra4`.`ingredientes` (`ID`, `nombre`, `precio`) VALUES ('5', 'peperoni', '800');

INSERT INTO `progra4`.`pizza` (`ID`, `nombre`, `precio`) VALUES ('1', 'Jamon y Queso', '5000');
INSERT INTO `progra4`.`pizza` (`ID`, `nombre`, `precio`) VALUES ('6', 'Margarita', '5500');
INSERT INTO `progra4`.`pizza` (`ID`, `nombre`, `precio`) VALUES ('3', 'Peperoni', '6000');
INSERT INTO `progra4`.`pizza` (`ID`, `nombre`, `precio`) VALUES ('4', 'Hongonada', '6000');
INSERT INTO `progra4`.`pizza` (`ID`, `nombre`, `precio`) VALUES ('5', 'Suprema', '7500');

INSERT INTO `progra4`.`relacion_pizza_ingredientes` (`pizza`, `ingrediente`) VALUESusuariousuario ('1', '1');
INSERT INTO `progra4`.`relacion_pizza_ingredientes` (`pizza`, `ingrediente`) VALUES ('1', '3');

INSERT INTO `progra4`.`comentario` ( `descripcion`, `usuario_coment_id`) VALUES ( 'Amo a shirley', '444');
